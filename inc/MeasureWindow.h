...
class MeasureWindow : public wxWindow
{
	...
	using pore_coord_t = std::pair<uint16_t, coord_t>;
...
public:
	static wxWindowID slider_algorithm_id, button_color_id, checkbox_color_id;
	wxSlider* m_slider_algorithm;
	wxCheckBox* m_checkBox_colorize;
